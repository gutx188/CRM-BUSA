      ...
      <PageHeader
        ...
        actions={
          <div className="flex flex-wrap gap-2">
            ...
            <Button variant="ghost" onClick={exportarCsv} disabled={filtradas.length === 0}>
              Exportar CSV
            </Button>
            <Button onClick={exportarPdf} disabled={pdfBusy || filtradas.length === 0}>
        ...
        <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
          ...
          <Field label="Opções do PDF">
            <label className="flex h-11 cursor-pointer items-center gap-2.5 rounded-xl border border-line-soft bg-elevated px-3 text-sm text-slate-300">
              ...
              />
              Incluir ficha individual por assistência
            </label>
          </Field>
        </div>
